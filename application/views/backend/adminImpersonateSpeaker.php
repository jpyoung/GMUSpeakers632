    ...
    <div class='cell well'>
        <div class='cell cell--s well'>
            <h1 class='h2 mbm mtm tac thb tfl twn'>
                To modify a speakers information or talks, you may simply impersonate the speaker; which will allow you to login into their accounts directly.  
            </h1>
        </div>
            ...
            <div class='g-b g-b--l--1of2'>
                <article class='card card--a course' id='course_115'>
                    <div style="float: right">
                        <a href="<?php echo base_url();?>index.php/admin/impersonate_speaker?impuid=<?php echo $row->u_id; ?>" class="btn btn--html-css admin-delete-btn">Impersonate</a>
                    </div>
