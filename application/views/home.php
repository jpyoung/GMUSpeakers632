    ...
    <!--<div class="cell">-->
        <!--<nav class="nav nav--sub" id="account-navigation">-->
            <!--<select class="nav-select">-->
                <!--<option selected="selected" value="/account">Dashboard</option>-->
                <!--<option value="/account/subscription">Subscription</option>-->
                <!--<option value="/account/transactions">History</option>-->
                <!--<option value="/account/prizes">Rewards</option>-->
            <!--</select>-->
            <!--<ul class="nav-list list dn db--m">-->
                <!--<li class="is-active list-item nav-item">-->
                    <!--<a href="/account" class="nav-item-link list-item-link">Dashboard</a>-->
                <!--</li>-->
                <!--<li class="nav-item list-item">-->
                    <!--<a href="/account/subscription" class="nav-item-link list-item-link">Subscription</a>-->
                <!--</li>-->
                <!--<li class="nav-item list-item">-->
                    <!--<a href="/account/transactions" class="nav-item-link list-item-link">History</a>-->
                <!--</li>-->
                <!--<li class="nav-item list-item">-->
                    <!--<a href="/account/prizes" class="nav-item-link list-item-link">Rewards</a>-->
                <!--</li>-->
            <!--</ul>-->
        <!--</nav>-->
    <!--</div>-->
...
<main class="content is-userBar-expanded"><div class="row row--b">
    <div class="cell well tci">
        ...
        <div class="g mbxl--m">
            <div class="g-b g-b--m--1of2">
                <div id="fixVideoBox" class="card card--a card--xs">

                    <iframe width="529" height="315" src="http://www.youtube.com/embed/ZYnk2AW616w?list=UU_I9YrZIS3IT8yMQTWiQMyg" frameborder="0" allowfullscreen></iframe>

                </div>
            </div>
            <div class="g-b g-b--m--1of2">
                <p class="mtm tsxl tfl">
    ...
    <div class="row">
        <div class="cell well well--l">
            <h2 id="keyNote" class="mbm tac">
                POPULAR SPEAKERS

            </h2>
            <div class="g">
                <div class="g-b g-b--m--1of2 g-b--xl--1of4">
                    <div class="card card--a pathSelect">
                        ...
                        <a href="/paths/ruby" class="btn btn--ruby card-item">View Jeff's Talks</a>
                    </div>
                </div>
                <div class="g-b g-b--m--1of2 g-b--xl--1of4">
                    <div class="card card--a pathSelect">
                        ...
                        <a href="/paths/javascript" class="btn btn--javascript card-item">View Don's Talks</a>
                    </div>
                </div>
                <div class="g-b g-b--m--1of2 g-b--xl--1of4">
                    <div class="card card--a pathSelect">
                        ...
                        <a href="/paths/html-css" class="btn btn--html-css card-item">View Karen's Talks</a>
                    </div>
                </div>
                <div class="g-b g-b--m--1of2 g-b--xl--1of4">
                    <div class="card card--a pathSelect">
                        ...
                        <a href="/paths/ios" class="btn btn--ios card-item">View Maurice's Talks</a>
                    </div>
                </div>
            </div>
        </div>
